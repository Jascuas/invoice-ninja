    ...
    <div className="px-6 pt-6 2xl:container">
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div className="md:col-span-2 lg:col-span-1">
          <div className="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-700 bg-gray-900">
            <svg
        ...
        <div>
          <div className="h-full py-6 px-6 rounded-xl border border-gray-700 bg-gray-900">
            <h5 className="text-xl text-white">Downloads</h5>
            <div className="my-8">
        ...
        <div>
          <div className="lg:h-full py-8 px-6 text-white rounded-xl border border-gray-700 bg-gray-900">
            <svg
